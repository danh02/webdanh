                                    ...
                                    <table class="table table-borderless table-data3">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#delete-contact<?php echo $rows['n_contact_id']; ?>">Delete</button>
                                                </td>
                                            </tr>
                                            <?php
                                                    }
                    ...
                    <form role="form" method="POST" action="">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>Are you sure you want to delete contact with name <b><?php echo $rows['v_fullname']; ?></b>?</p>
                            </div>
