...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['delete_subscriber'])) {
        $new_subscribe = new Subscribe($db);
        $new_subscribe->n_sub_id = $_POST['sub_id'];
        if ($new_subscribe->delete()) {
                                    ...
                                    <table class="table table-borderless table-data3">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#delete-subscriber<?php echo $rows['n_sub_id']; ?>">Delete</button>
                                                </td>
                                            </tr>
                                            <?php
                                                    }
                    ...
                    <form role="form" method="POST" action="">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>Are you sure you want to delete subscriber with email <b><?php echo $rows['v_sub_email']; ?></b>?</p>
                            </div>
