...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['delete_comment'])) {
        $new_comment = new comment($db);
        $new_comment->n_blog_comment_id = $_POST['comment_id'];
                                    ...
                                    <table class="table table-borderless table-data3">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#delete-comment<?php echo $rows['n_blog_comment_id']; ?>">Delete</button>
                                                </td>
                                            </tr>
                                            <?php
                                                    }
