...
class blog {
	...
	public function read_search($key){
		$sql = "SELECT * FROM $this->table WHERE v_post_title LIKE '%$key%'";
	...
	public function read_newest_blog(){
		$sql = "SELECT * FROM $this->table ORDER BY n_blog_post_id DESC LIMIT 4";
	...
	public function read_slider() {
		$sql = "SELECT * FROM $this->table WHERE n_home_page_place > 0 ORDER BY n_blog_post_id DESC LIMIT 3";
